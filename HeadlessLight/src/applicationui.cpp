        ...
        m_invokeManager(new InvokeManager(this))
{
    ...
    request.setAction("com.CellNinja.HeadlessLightService.START");
...
void ApplicationUI::onSystemLanguageChanged()
{
    ...
    QString file_name = QString("HeadlessLight_%1").arg(locale_string);
...
void ApplicationUI::shutdown()
{
    InvokeRequest request;
    request.setTarget("com.CellNinja.HeadlessLightService");
    request.setAction("com.CellNinja.HeadlessLightService.SHUTDOWN");
    m_invokeManager->invoke(request);
